...
* Système d'exploitation : Red Hat Enterprise Linux et CentOS version 7.x et 8.x, basé sur l'architecture x86_64, installés à l'aide de l'environnement de base "Server avec interface utilisateur graphique" de l'option *Software Selection* du programme d'installation du système d'exploitation
