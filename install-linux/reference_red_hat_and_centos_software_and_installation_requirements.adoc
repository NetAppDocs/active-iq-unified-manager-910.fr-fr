...
* Red Hat Enterprise Linux ou CentOS version 7.x et 8.x, basé sur l'architecture x86_64. CentOS Stream n'est pas pris en charge.
...
* MySQL Community Edition version 8.0.27 (à partir du référentiel MySQL).
* OpenJDK version 11.0.12 (à partir du référentiel Red Hat Extra Enterprise Linux Server)
* Python 3.6.x
