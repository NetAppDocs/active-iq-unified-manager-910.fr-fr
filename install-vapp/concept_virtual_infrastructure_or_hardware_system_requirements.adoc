...
De plus, il existe une limite au nombre de nœuds qu'une seule instance d'Unified Manager peut surveiller avant que vous n'installiez une seconde instance d'Unified Manager. Pour plus d'informations, voir link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["Guide des meilleures pratiques de Unified Manager"^]
